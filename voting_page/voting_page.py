...
authenticator = stauth.Authenticate(
    credentials={
        'usernames':
            {st.secrets['user1']:
                {'failed_login_attempts': st.secrets['user1_failed_login_attempts'],
                 'logged_in': st.secrets['user1_logged_in'],
                 'name': st.secrets['user1_name'],
                 'password':st.secrets['user1_password']
                 }
             }
        },
